...
module mkHwMain#(Ulx3sSdramUserIfc mem) (HwMainIfc);
	...
	// Each 4x4 matrix contains exactly sixteen 32-bit values.  A depth of 16
	// preserves the one-word-per-cycle FIFO interface without consuming a DP16KD.
	FIFO#(Bit#(32)) inputAQ <- mkSizedFIFO(16);
	FIFO#(Bit#(32)) inputBQ <- mkSizedFIFO(16);
